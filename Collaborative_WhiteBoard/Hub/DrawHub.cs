...
namespace Microsoft.Azure.SignalR.Samples.Whiteboard
{
    public class DrawHub : Hub
    {
        ...
        {
            diagram.UserNamesList.Remove(Context.ConnectionId);
            
            return Clients.All.SendAsync("UpdatedUserList", diagram.UserNamesList);
        }
        ...
        {
            diagram.UserNamesList.Add(Context.ConnectionId, name);
            Console.WriteLine(diagram.Shapes);    
            await Clients.All.SendAsync("UpdatedUserList", diagram.UserNamesList);
